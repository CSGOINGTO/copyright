...
public class CitiApiUtils {
    ...
    public String getRSA(String password){
        ...
        // 读js文件
        String jsFile = ServletActionContext.getServletContext().getRealPath("./RSA.js");
    ...
    public void Step3(){
        ...
        String password = this.getRSA(this.password);
    ...
    public String getCLIENT_SCRENT() {
        return CLIENT_SCRENT;
    }
